                    ...
                    <Stack>
                      <Stack direction="row" spacing={0.5} alignItems="center">
                        ...
                        <Typography component="span" variant="h4" sx={{ fontWeight: 400 }}>
                          {`${adminData?.firstName?.charAt(0).toUpperCase() + adminData?.firstName.slice(1)} ${adminData.lastName}`}
                        </Typography>
                      </Stack>
                      <Typography variant="subtitle2"> {adminData.role === 'admin' ? 'Project Admin' : ''}</Typography>
                    </Stack>
                  </Box>
