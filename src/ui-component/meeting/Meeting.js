...
const Meetings = ({ toggleVisibilityMeeting, isVisibleMeetings }) => {
        ...
        <Grid container display="flex" alignItems="center">
          <Stack direction="row" alignItems="center" justifyContent={'space-between'} width={'100%'}>
            ...
            <Stack direction="row" alignItems="center" justifyContent={'flex-end'} spacing={2}>
              {isVisibleMeetings && (
                <Button variant="contained" color="secondary" size="small" startIcon={<AddIcon />} onClick={handleOpenMeeting}>
                  Create Meeting
                </Button>
              )}
            </Stack>
