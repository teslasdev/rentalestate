...
const Claim = ({ toggleVisibilityClaim, isVisibleClaim }) => {
  ...
  return (
    <div>
      {/* View Claim */}
      <ViewClaim open={openClaimView} handleClose={handleCloseClaimView} />

      {/* Add Claim */}
      <Addclaim open={openClaim} handleClose={handleCloseClaim} />
