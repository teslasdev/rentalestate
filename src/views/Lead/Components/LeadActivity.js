...
import SendMailDialog from './LeadActivityDialogs/sendMailDialog';
import CallDialog from './LeadActivityDialogs/CallDialog';
import CreateTaskDialog from './LeadActivityDialogs/CreateTaskDialog';
import AddMeetingDialog from './LeadActivityDialogs/AddMeetingDialog';
...
export default function EmailGrid(props) {
  ...
  const emailsToShow = data.Email;

  const callsToShow = data.phoneCall;
  const taskToShow = data.task;
  const meetingToShow = data.meeting;
  ...
  return (
    <Box>
      ...
      <CallDialog open={openCallDialog} onClose={handleCloseCallDialog} recipientName={props.data.lead.leadName} />
      <SendMailDialog open={openSendMailDialog} onClose={handleCloseSendMailDialog} recipientEmail={props.data.lead.leadEmail} />
