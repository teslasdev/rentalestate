          ...
          <Grid container display="flex" spacing={4}>
            ...
            <Grid item xs={12} sm={6}>
              ...
              <Grid style={{ borderBottom: '1.5px dashed', borderBottomColor: Palette.grey[400] }} py={2}>
                ...
                {/* <Typography variant="body2" color={Palette.grey[600]}>
                  {data?.leadStatus ? data?.leadStatus : '--'}
                </Typography> */}
              </Grid>
            </Grid>
            <Grid item xs={12} sm={6}>
              <Grid style={{ borderBottom: '1.5px dashed', borderBottomColor: Palette.grey[400] }} pb={2}>
                ...
                {/* <Typography display="flex">
                  ...
                  <Typography variant="body2" color={Palette.grey[600]} pl={1}>
                    {data?.leadScore}
                  </Typography>
                </Typography> */}
              </Grid>
              <Grid style={{ borderBottom: '1.5px dashed', borderBottomColor: Palette.grey[400] }} py={2}>
                ...
                {/* <Typography variant="body2" color={Palette.primary.main} textTransform={'capitalize'}>
                  <Link
                    to={`/dashboard/user/view/${data?.assigned_agent?._id}`}
                    style={{ cursor: 'pointer', textDecoration: 'none', color: Palette.primary.main }}
                  >
            ...
            <Grid item xs={12} sm={6}>
              ...
              <Grid style={{ borderBottom: '1.5px dashed', borderBottomColor: Palette.grey[400] }} py={2}>
                ...
                {/* <Typography variant="body2" color={Palette.grey[600]}>
                  {data?.additionalEmailAddress ? data?.additionalEmailAddress : '--'}
                </Typography> */}
              </Grid>
            </Grid>
            <Grid item xs={12} sm={6}>
              <Grid style={{ borderBottom: '1.5px dashed', borderBottomColor: Palette.grey[400] }} pb={2}>
                ...
                {/* <Typography
                  ...
                  onClick={() => (data?.instagramProfile ? handleInsta(data?.instagramProfile) : '--')}
                  style={{ cursor: 'pointer', textDecoration: 'none', color: Palette.primary.main }}
                >
              ...
              <Grid style={{ borderBottom: '1.5px dashed', borderBottomColor: Palette.grey[400] }} py={2}>
                ...
                {/* <Typography
                  variant="body2"
                  color={Palette.grey[600]}
                  onClick={() => (data?.twitterProfile ? handleTwitter(data?.twitterProfile) : '--')}
                  style={{ cursor: 'pointer', textDecoration: 'none', color: Palette.primary.main }}
                >
            ...
            <Grid item xs={12} sm={6}>
              <Grid style={{ borderBottom: '1.5px dashed', borderBottomColor: Palette.grey[400] }} pb={2}>
                ...
                {/* <Typography variant="body2" color={Palette.grey[600]}>
                  {data?.typeOfInsurance ? data?.typeOfInsurance : '--'}
                </Typography> */}
              </Grid>
              <Grid style={{ borderBottom: '1.5px dashed', borderBottomColor: Palette.grey[400] }} py={2}>
                <Typography variant="body1">Desired Coverage Amount :</Typography>
                {/* <Typography variant="body2" color={Palette.grey[600]}>
                  {data?.desiredCoverageAmount ? data?.desiredCoverageAmount : '--'} <span style={{ marginLeft: '3px' }}>&#8377;</span>
                </Typography> */}
              </Grid>
            </Grid>
            <Grid item xs={12} sm={6}>
              <Grid style={{ borderBottom: '1.5px dashed', borderBottomColor: Palette.grey[400] }} pb={2}>
                ...
                {/* <Typography variant="body2" color={Palette.grey[600]}>
                  {data?.specificPolicyFeatures ? data?.specificPolicyFeatures : '--'}
                </Typography> */}
              </Grid>
            </Grid>
            ...
            <Grid item xs={12} sm={12}>
              <Grid style={{ borderBottom: '1.5px dashed', borderBottomColor: Palette.grey[400] }} pb={2}>
                ...
                {/* <Typography variant="body2" color={Palette.grey[600]}>
                  {data?.QualificationStatus ? data?.QualificationStatus : '--'}
                </Typography> */}
              </Grid>
            </Grid>
            ...
            <Grid item xs={12} sm={6}>
              <Grid style={{ borderBottom: '1.5px dashed', borderBottomColor: Palette.grey[400] }} pb={2}>
                ...
                {/* <Typography variant="body2" color={Palette.grey[600]}>
                  {data?.policyType ? data?.policyType : '--'}
                </Typography> */}
              </Grid>
              <Grid style={{ borderBottom: '1.5px dashed', borderBottomColor: Palette.grey[400] }} py={2}>
              ...
              <Grid style={{ borderBottom: '1.5px dashed', borderBottomColor: Palette.grey[400] }} py={2}>
                ...
                {/* <Typography variant="body2" color={Palette.grey[600]}>
                  {data?.coverageAmount ? data?.coverageAmount : '--'} <span style={{ marginLeft: '3px' }}>&#8377;</span>
                </Typography> */}
              </Grid>
              <Grid style={{ borderBottom: '1.5px dashed', borderBottomColor: Palette.grey[400] }} py={2}>
            ...
            <Grid item xs={12} sm={6}>
              <Grid style={{ borderBottom: '1.5px dashed', borderBottomColor: Palette.grey[400] }} pb={2}>
                ...
                {/* <Typography variant="body2" color={Palette.grey[600]}>
                  {data?.policyNumber ? data?.policyNumber : '--'}{' '}
                </Typography> */}
              </Grid>
              <Grid style={{ borderBottom: '1.5px dashed', borderBottomColor: Palette.grey[400] }} py={2}>
              ...
              <Grid style={{ borderBottom: '1.5px dashed', borderBottomColor: Palette.grey[400] }} py={2}>
                ...
                {/* <Typography variant="body2" color={Palette.grey[600]}>
                  {data?.termLength ? data?.termLength : '--'}
                </Typography> */}
              </Grid>
            </Grid>
            ...
            <Grid item xs={12} sm={6}>
              <Grid style={{ borderBottom: '1.5px dashed', borderBottomColor: Palette.grey[400] }} pb={2}>
                ...
                {/* <Typography variant="body2" color={Palette.grey[600]}>
                  {data?.leadPriority ? data?.leadPriority : '--'}
                </Typography> */}
              </Grid>
            </Grid>
          </Grid>
