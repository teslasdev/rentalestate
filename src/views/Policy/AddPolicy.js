            ...
            <DialogContentText id="scroll-dialog-description" tabIndex={-1}>
                ...
                <Grid item xs={12} sm={6} md={6}>
                  <FormControl fullWidth>
                    ...
                    <Select
                      ...
                      onChange={formik.handleChange}
                      error={formik.touched.policyStatus && Boolean(formik.errors.policyStatus)}
                      helperText={formik.touched.policyStatus && formik.errors.policyStatus}
                    >
              ...
              <Grid container rowSpacing={3} columnSpacing={{ xs: 0, sm: 5, md: 4 }}>
                <Grid item xs={12} sm={6} md={6}>
                  ...
                  <TextField
                    ...
                    onChange={formik.handleChange}
                    error={formik.touched.coverageAmounts && Boolean(formik.errors.coverageAmounts)}
                    helperText={formik.touched.coverageAmounts && formik.errors.coverageAmounts}
                  />
                </Grid>
                <Grid item xs={12} sm={6} md={6}>
                  ...
                  <TextField
                    ...
                    onChange={formik.handleChange}
                    error={formik.touched.deductibles && Boolean(formik.errors.deductibles)}
                ...
                <Grid item xs={12} sm={12} md={12}>
                  ...
                  <TextField
                    ...
                    onChange={formik.handleChange}
                    error={formik.touched.limits && Boolean(formik.errors.limits)}
                    helperText={formik.touched.limits && formik.errors.limits}
                  />
                </Grid>
              </Grid>
              <Typography style={{ marginBottom: '15px', marginTop: '15px' }} variant="h6">
              ...
              <Grid container rowSpacing={3} columnSpacing={{ xs: 0, sm: 5, md: 4 }}>
                ...
                <Grid item xs={12} sm={6} md={6}>
                  ...
                  />
                  {formik.values.additionalInstagramProfile && (
                    <a href={`https://www.instagram.com/${formik.values.additionalInstagramProfile}`} target="_blank" rel="noreferrer">
                      Link
                    </a>
                  )}
                </Grid>
                <Grid item xs={12} sm={6} md={6}>
                  ...
                  />
                  {formik.values.additionalTwitterProfile && (
                    <a href={`https://twitter.com/${formik.values.additionalTwitterProfile}`} target="_blank" rel="noreferrer">
                      Link
                    </a>
                  )}
                </Grid>
                ...
                <Grid item xs={12} sm={6} md={6}>
                  <FormControl fullWidth>
                    ...
                    >
                      ...
                      <MenuItem value="Policyholder's property located in a low-risk area">
                        Policyholder`s property located in a low-risk area
                      </MenuItem>
                      <MenuItem value="Underwriter consulted with the claims department to assess potential risks.">
                        Underwriter consulted with the claims department to assess potential risks.{' '}
                      </MenuItem>
                    </Select>
                  </FormControl>
                </Grid>
